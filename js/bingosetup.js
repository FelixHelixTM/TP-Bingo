function bingosetup() {
    ...
    $("#bingo tr td:not(.popout), #selected td").toggle(
		function () {
		  $(this).addClass("purplesquare");
		},
		function () {
		  $(this).addClass("greensquare").removeClass("purplesquare");
		},
		function () {
	...
	var results = $("#results");
	results.append ("<p>TP Bingo: <strong>" + bingoList["info"].version + "</strong>&emsp;Seed: <strong>" + 
